...
INPUT_FILE="/nfsdata-117/Project/DeepEyes_Benchmark/dataoutput_classified/mixed_判断.json"
...
API_KEY="sk-133aba04c45f41f3b867c7d5e8287989"                            # API密钥
...
# 性能与并发配置
# ==============================================================================
WORKERS=4                                               # 并发线程数（根据API限流调整，建议2-10）
...
LIMIT="15"                                                # 限制处理数量：设置为数字（如"10"）只处理前N张图片，设置为空字符串("")处理全部图片
