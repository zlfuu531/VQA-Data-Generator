...
INPUT_FILE="/nfsdata-117/project/DeepEyes_Benchmark/qa_pipline12-7/qa_last_test/check_image/2_2精标-154.xlsx"

# 输出目录（可以自己设置为任意文件夹，支持绝对/相对路径）
# - 不同任务建议改个子目录名，避免混在一起
OUTPUT_DIR="$SCRIPT_DIR/outputs/aliyun-2-2-jingbiao"
