...
# 评测脚本 - 开源模型
# ==============================================================================
# 用途：运行金融领域多用户画像评测（四个开源模型）
# 说明：所有配置项都在下面，直接修改即可
# 模型列表：qwen3-vl-32b-thinking, qwen3-vl-235b-a22b-thinking, InternVL3_5-30B-A3B, InternVL3_5-241B-A28B
# ==============================================================================
set -eu
...
INPUT_FILE="/home/zenglingfeng/qa_pipline12-7/evaluate/outputs/用户画像实验开源/提示词实验开源均匀0_4-12-26.xlsx" # 输入文件路径（支持 .json, .jsonl 或 .csv）
#OUTPUT_FILE="last_evaluate提示词实验.jsonl"                       # 只需要填写输出文件名，不要填写路径（支持 .json 或 .jsonl，根据扩展名自动判断格式）
OUTPUT_FILE="提示词实验12-28.jsonl"
...
LOG_DIR="./evaluate_logs1222"                                  # 日志目录
LOG_LEVEL="INFO"                                           # 日志级别：DEBUG/INFO/WARNING/ERROR

# ==============================================================================
# 模型配置（固定为当前模型）
# ==============================================================================
EVAL_MODELS="qwen3-vl-235b-a22b-thinking,qwen3-vl-32b-thinking"  # 当前脚本评测的模型：四个开源模型
...
PROFILES="expert,expert_cot"                                             # 用户画像列表（逗号分隔），空字符串表示使用所有
#beginner,retail,
# ==============================================================================
# 运行配置
# ==============================================================================
...
# ==============================================================================
echo "=============================================================================="
echo "评测配置 - 开源模型（qwen3-vl-32b-thinking, qwen3-vl-235b-a22b-thinking, InternVL3_5-30B-A3B, InternVL3_5-241B-A28B）"
echo "=============================================================================="
