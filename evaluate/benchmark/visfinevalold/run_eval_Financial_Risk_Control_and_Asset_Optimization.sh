#!/bin/bash
# ==============================================================================
# VisFinEval 数据集评测脚本 - Financial_Risk_Control_and_Asset_Optimization
# ==============================================================================
# 用途：使用 evaluate_py 框架评测 VisFinEval 数据集（Financial_Risk_Control_and_Asset_Optimization.jsonl）
...
# ==============================================================================
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
INPUT_FILE="$SCRIPT_DIR/Financial_Risk_Control_and_Asset_Optimization.jsonl"      # VisFinEval 数据文件
OUTPUT_FILE="Financial_Risk_Control_and_Asset_Optimization.jsonl"                              # 只需要填写输出文件名，不要填写路径（支持 .json 或 .jsonl，根据扩展名自动判断格式）
...
EVAL_MODELS="Qwen3-VL-8B-Thinking,Qwen3-VL-8B-Instruct,qwen3-vl-32b-thinking,qwen3-vl-235b-a22b-thinking,InternVL3_5-30B-A3B,InternVL3_5-241B-A28B"
...
# ==============================================================================
echo "=============================================================================="
echo "评测配置 - Financial_Risk_Control_and_Asset_Optimization"
echo "=============================================================================="
