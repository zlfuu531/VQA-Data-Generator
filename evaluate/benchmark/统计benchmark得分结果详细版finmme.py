...
def find_finmme_result_files(base_dir):
    ...
    # 查找json文件
    for json_file in base_path.rglob("finmme_eval_results.json"):
        result_files.append(json_file)
    
    # 查找jsonl文件
    for jsonl_file in base_path.rglob("finmme_eval_results.jsonl"):
...
def main():
    ...
    output_file = "/home/zenglingfeng/qa_pipline12-7/evaluate/benchmark/finmme-1-8.xlsx"
