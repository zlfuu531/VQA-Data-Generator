#!/bin/bash
# ==============================================================================
# FinMMR 数据集评测脚本 - qwen3-vl-32b-thinking
# ==============================================================================
# 用途：使用 evaluate_py 框架评测 FinMMR 数据集（qwen3-vl-32b-thinking）
# 说明：所有配置项都在下面，直接修改即可
# ==============================================================================
set -eu
...
# ==============================================================================
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
INPUT_FILE="$SCRIPT_DIR/FinMMR_data_origin.json"      # FinMMR 数据文件（已提取的原始数据）
OUTPUT_FILE="finmmr.jsonl"                              # 只需要填写输出文件名，不要填写路径（支持 .json 或 .jsonl，根据扩展名自动判断格式）
