#!/bin/bash
# ==============================================================================
# FinMMR 数据集评测脚本 - qwen3-vl-235b-a22b-thinking
# ==============================================================================
# 用途：使用 evaluate_py 框架评测 FinMMR 数据集（qwen3-vl-235b-a22b-thinking）
# 说明：所有配置项都在下面，直接修改即可
# ==============================================================================
set -eu
...
OUTPUT_FILE="finmmr.json"                              # 只需要填写输出文件名，不要填写路径（支持 .json 或 .jsonl，根据扩展名自动判断格式）
