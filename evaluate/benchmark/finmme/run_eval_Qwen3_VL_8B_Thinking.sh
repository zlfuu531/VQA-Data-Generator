...
# 模型配置（固定为当前模型）
# ==============================================================================
EVAL_MODELS="Qwen3-VL-8B-Thinking"                                    # 当前脚本评测的模型：Qwen3-VL-8B-Thinking
...
# 输出文件配置
# ==============================================================================
OUTPUT_FILE="finmme_eval_results-new.jsonl"                   # 只需要填写输出文件名，不要填写路径（支持 .json 或 .jsonl，根据扩展名自动判断格式）
...
# 构建环境变量（传递给Python脚本）
# ==============================================================================
export EVAL_MODELS="Qwen3-VL-8B-Thinking"
