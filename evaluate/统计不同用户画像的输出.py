...
DEFAULT_OUTPUT_FILE: Optional[str] = "/home/zenglingfeng/qa_pipline12-7/evaluate/outputs/用户画像实验终10-30/expert12-30-2.xlsx"
...
DEFAULT_FILE_PATTERN: Optional[str] = "提示词实验12-29.jsonl"
...
def aggregate_results_to_csv(
    ...
    for record_key, items in items_by_key.items():
        ...
        if resume and existing_row and not models_to_update:
            skipped_models_count += len(all_item_models)
            continue
