...
# 评测脚本 - MiniCPM-V-4_5
# ==============================================================================
# 用途：运行金融领域多用户画像评测（MiniCPM-V-4_5）
# 说明：所有配置项都在下面，直接修改即可
# ==============================================================================
set -eu
...
LOG_DIR="./evaluate_logs1229"                                  # 日志目录
LOG_LEVEL="INFO"                                           # 日志级别：DEBUG/INFO/WARNING/ERROR

# ==============================================================================
# 模型配置（固定为当前模型）
# ==============================================================================
EVAL_MODELS="InternVL3_5-241B-A28B"                                    # 当前脚本评测的模型：MiniCPM-V-4_5
