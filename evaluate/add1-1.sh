#!/bin/bash
# ==============================================================================
# 评测脚本 - qwen3-vl-235b-a22b-thinking
# ==============================================================================
...
INPUT_FILE="/nfsdata-117/project/DeepEyes_Benchmark/QA-Check/wuzhenyu/mixed_again.json" # 输入文件路径（支持 .json, .jsonl 或 .csv）
OUTPUT_FILE="add1-1.jsonl"                            # 只需要填写输出文件名，不要填写路径（支持 .json 或 .jsonl，根据扩展名自动判断格式）
...
LOG_DIR="./evaluate_logs11"                                  # 日志目录
LOG_LEVEL="INFO"                                           # 日志级别：DEBUG/INFO/WARNING/ERROR

# ==============================================================================
# 模型配置（固定为当前模型）
# ==============================================================================
EVAL_MODELS="qwen3-vl-235b-a22b-thinking"  # 当前脚本评测的模型：四个开源模型InternVL3_5-30B-A3B,
#InternVL3_5-241B-A28B,qwen3-vl-235b-a22b-thinking,,,Llama-3.2-11B-Vision
#EVAL_MODELS="grok-4-1-fast-reasoning"                                    # 当前脚本评测的模型：qwen3-vl-235b-a22b-thinking
#claude-sonnet-4-5-20250929,gpt-5.1-2025-11-13,gemini-3-pro-preview,
# ==============================================================================
# 用户画像配置
# ==============================================================================
# 四种用户画像提示词：
...
MAX_RETRIES=1                                               # 请求失败时的最大重试次数，默认3次
...
export EVAL_SKIP_MISSING_IMAGES="$SKIP_MISSING_IMAGES"      # 图片缺失时是否继续评测（不包含图片）
